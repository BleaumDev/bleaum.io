...
//         {/* Uniform solid background - removed all overlays and gradients */}
...
//                 className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 backdrop-blur-sm border border-blue-400/30 rounded-full px-6 py-3 mb-8"
//               >
//                 <Award className="w-5 h-5 text-blue-400" />
//                 <span className="text-blue-200 font-medium">Trusted by 300+ Retailers</span>
...
//                     className="text-xl md:text-2xl text-blue-200 leading-relaxed max-w-4xl mx-auto"
//               >
...
//                 <Link href="/demo">
//                     <button className="group relative bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-10 py-4 rounded-2xl text-lg font-semibold overflow-hidden shadow-2xl">
...
//                 <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
//                 <button
//                     className="group border-2 border-blue-500/50 text-blue-200 px-10 py-4 rounded-2xl text-lg font-semibold hover:border-cyan-400 hover:text-cyan-300 transition-all duration-300 backdrop-blur-sm"
//                   onClick={() => window.location.href = '/demo'}
//                 >
//                     <span className="flex items-center gap-3">
//                       <Play className="w-5 h-5 text-blue-400 group-hover:text-cyan-400 transition-colors" />
//                       Watch Demo
//                     </span>
//                 </button>
//                 </motion.div>
...
//         <section data-section="1" className="py-16 relative">
...
//             >
//               <div
//                 className="relative w-full aspect-[16/9] rounded-3xl overflow-hidden shadow-2xl flex items-center justify-center cursor-pointer group"
//                 onClick={() => window.location.href = '/demo'}
//                 style={{ backgroundImage: 'url(/IMAGE.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}
//               >
//                 <div className="absolute inset-0 bg-black/30" />
//                 <motion.button
//                   className="relative z-10 flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-r from-blue-500 to-cyan-400 shadow-2xl border-4 border-white/30 group-hover:border-cyan-400 group-hover:scale-110 transition-all duration-300"
...
//                     <h3 className="text-white font-bold text-lg mb-2">Platform Demo</h3>
//                     <p className="text-blue-200 text-sm">See how Bleaum streamlines retail operations</p>
//                   </div>
//                 </div>
//               </div>
//             </motion.div>
...
//         <section data-section="2" className="py-24 relative rounded-3xl">
...
//                   }
//                 }}
//                 className="hidden md:flex items-center justify-center absolute -left-6 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 text-white shadow-2xl border-2 border-white/20 hover:scale-110 hover:border-cyan-300 transition-all duration-200 opacity-90 hover:opacity-100"
//               >
...
//                   }
//                 }}
//                 className="hidden md:flex items-center justify-center absolute -right-6 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 text-white shadow-2xl border-2 border-white/20 hover:scale-110 hover:border-cyan-300 transition-all duration-200 opacity-90 hover:opacity-100"
//               >
//                 <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
...
//                 className="flex gap-6 overflow-x-auto snap-x scroll-smooth scrollbar-hide pb-4"
//                 style={{ scrollBehavior: "smooth" }}
//               >
//                 {[
//                   // {
//                   //   src: "https://images.unsplash.com/photo-1523287562758-66c7fc58967f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNjAzNTV8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTA3OTA0MzR8&ixlib=rb-4.1.0&q=80&w=400&h=500",
...
//                   {
//                     // src: "https://images.unsplash.com/photo-1554774853-aae0a22c8aa4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNjAzNTV8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTA3OTA0MzR8&ixlib=rb-4.1.0&q=80&w=400&h=500",
...
//                   },
//                   {
//                     // src: "https://images.unsplash.com/photo-1586953208448-b95a79798f07?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wzNjAzNTV8MHwxfHJhbmRvbXx8fHx8fHx8fDE3NTA3OTA0MzR8&ixlib=rb-4.1.0&q=80&w=400&h=500",
//                     src:"/inventory.png",
...
//                     viewport={{ once: true }}
//                   >
//                     <div className="relative w-80 h-96 rounded-3xl overflow-hidden bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 group-hover:border-blue-500/50 transition-all duration-500">
//                       <img
...
//         {/* Features Section */}
//         <section data-section="3" className="py-32 relative" id="features">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//             {/* Section Header */}
//             <motion.div
...
//                   whileHover={{ y: -10 }}
//               >
//                   <div className="relative bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-3xl p-8 h-full overflow-hidden group-hover:border-blue-500/50 transition-all duration-500">
//                     {/* Hover effect */}
//                     <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-cyan-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

//                     <div className="relative z-10">
//                       <div className="bg-gradient-to-br from-blue-500 to-cyan-500 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 text-white group-hover:scale-110 transition-transform duration-300">
//                   {feature.icon}
//                 </div>
...
//                       <p className="text-blue-200 mb-6 leading-relaxed">{feature.description}</p>
...
//         <section data-section="4" className="py-32 relative bg-gradient-to-br from-blue-900/10 to-cyan-900/10">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
//                 <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-2xl p-6">
...
//                 </p>
//                   <div className="mt-4 text-blue-400 font-semibold">— AJ, Happy Root</div>
//               </div>
//             </motion.div>
...
//                           <span className="text-blue-100 text-sm">{product.name}</span>
//                           <span
...
//         <section data-section="5" className="py-32 relative">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
//             <motion.div
//                 initial={{ opacity: 0, x: -50 }}
...
//                     <p className="text-blue-100">AI-optimized delivery routes in real-time</p>
//                 </div>
...
//                     <div className="text-white font-semibold mb-3">Active Deliveries</div>
...
//                   </p>
//                   <div className="mt-4 text-blue-400 font-semibold">— Collin, Park Social</div>
//               </div>
//             </motion.div>
//           </div>
//         </div>
...
//       {/* Mobile App Section */}
//         <section data-section="6" className="py-32 relative bg-gradient-to-br from-blue-900/10 to-cyan-900/10">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
//             <motion.div
//                 initial={{ opacity: 0, x: -50 }}
...
//                 </p>
//                   <div className="mt-4 text-blue-400 font-semibold">— Hugo, Go Green</div>
//               </div>
//             </motion.div>
...
//                     <p className="text-blue-100">iOS & Android ready with app store deployment</p>
//                 </div>
//                 <div className="space-y-4">
//                   <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 flex items-center gap-4">
//                     <ShoppingCart className="w-6 h-6 text-white" />
//                       <div>
//                         <div className="text-white font-semibold">Seamless Shopping</div>
//                         <div className="text-blue-100 text-sm">Cart, checkout, and order tracking</div>
//                       </div>
//                   </div>
//                   <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 flex items-center gap-4">
...
//                         <div className="text-blue-100 text-sm">Multiple payment methods supported</div>
//                       </div>
//                   </div>
//                   <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 flex items-center gap-4">
//                     <Bell className="w-6 h-6 text-white" />
//                       <div>
//                         <div className="text-white font-semibold">Smart Notifications</div>
//                         <div className="text-blue-100 text-sm">Order updates and promotions</div>
//                       </div>
//                   </div>
//                 </div>
//               </div>
...
//         <section data-section="7" className="py-32 relative">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
//             <motion.div
//                 initial={{ opacity: 0, x: -50 }}
...
//                     <h3 className="text-xl font-bold mb-2">Smart Receipt System</h3>
//                     <p className="text-blue-100">Print, text, or email automatically based on customer preference</p>
//                 </div>
//                   <div className="space-y-4 mb-6">
//                   <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
//                       <div className="text-white font-semibold mb-2">Receipt Delivery Options:</div>
...
//                     </div>
//                     <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4">
//                       <div className="text-white font-semibold mb-2">Compliance Features:</div>
...
//                     difference."
//                   </p>
//                   <div className="mt-4 text-blue-400 font-semibold">— Cam, Project Releaf</div>
//               </div>
//             </motion.div>
//           </div>
//         </div>
...
//         <section data-section="8" className="py-32 relative bg-gradient-to-br from-blue-900/10 to-cyan-900/10">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//             <motion.div
//               className="text-center mb-20"
//               initial={{ opacity: 0, y: 30 }}
...
//                   whileHover={{ y: -10 }}
//               >
//                   <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-3xl p-8 h-full text-center group-hover:border-blue-500/50 transition-all duration-500">
//                     <div className="bg-gradient-to-br from-blue-500 to-cyan-500 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
//                   {feature.icon}
//                 </div>
...
//         {/* About Section */}
//         <section data-section="9" className="py-32 relative" id="about">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <motion.div
//               className="text-center mb-20"
//               initial={{ opacity: 0, y: 30 }}
...
//                 viewport={{ once: true }}
//               >
//                 <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-3xl p-8">
...
//                 </div>
//                     <div>
//                       <div className="text-white font-bold">Antonio Panella</div>
//                       <div className="text-blue-400">Founder & CEO</div>
//                 </div>
//               </div>
//             </div>
//               </motion.div>
...
//                     viewport={{ once: true }}
//                   >
//                     <div className="bg-gradient-to-br from-blue-500 to-cyan-500 w-12 h-12 rounded-xl flex items-center justify-center text-white flex-shrink-0">
//                       {item.icon}
//                     </div>
//                     <div>
...
//             >
//               {[
//                 { number: "300+", label: "Happy Retailers", icon: <Users className="w-6 h-6" /> },
...
//                 <motion.div
//                   key={stat.label}
//                   className="text-center bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-2xl p-6"
//                   initial={{ opacity: 0, scale: 0.8 }}
//                   whileInView={{ opacity: 1, scale: 1 }}
//                   transition={{ duration: 0.5, delay: index * 0.1 }}
//                   viewport={{ once: true }}
//                 >
//                   <div className="bg-gradient-to-br from-blue-500 to-cyan-500 w-12 h-12 rounded-xl flex items-center justify-center text-white mx-auto mb-4">
//                     {stat.icon}
//                   </div>
...
//         <section data-section="10" className="py-32 relative bg-gradient-to-br from-blue-900/10 to-cyan-900/10">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//             <motion.div
//               className="text-center mb-20"
//               initial={{ opacity: 0, y: 30 }}
...
//                   icon: <Link2 className="w-8 h-8 text-white-400" />,
//               },
//               {
//                   title: "Data Security",
//                   description: "Encrypted, backed-up, and SOC 2 compliant",
//                   icon: <Lock className="w-8 h-8 text-white-400" />,
//               },
//               {
//                   title: "Audit Ready",
//                   description: "Full audit trails & granular staff permissions",
//                   icon: <ScrollText className="w-8 h-8 text-white-400" />,
//                 },
...
//                   whileHover={{ y: -10 }}
//               >
//                   <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-3xl p-8 text-center h-full group-hover:border-blue-500/50 transition-all duration-500">
//                     <div className="bg-gradient-to-br from-blue-500 to-cyan-500 w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
//                   {feature.icon}
//                 </div>
//                     <h3 className="text-xl font-bold text-white mb-4 group-hover:text-cyan-400 transition-colors duration-300">
...
//         <section data-section="11" className="py-32 relative">
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//             <motion.div
//               className="text-center mb-20"
//               initial={{ opacity: 0, y: 30 }}
...
//                       {industry.title}
//                     </h3>
//                     <p className="text-blue-200 leading-relaxed">{industry.description}</p>
//                 </div>
//               </motion.div>
//             ))}
//           </div>
...
//         <section
//           data-section="12"
//           className="py-32 relative bg-gradient-to-br from-blue-900/10 to-cyan-900/10"
//           id="testimonials"
//         >
//           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
//           <motion.div
...
//         {/* CTA Section */}
//         <section data-section="13" className="py-32 relative overflow-hidden rounded-3xl">
...
//         <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center rounded-3xl">
//           <motion.div
//               initial={{ opacity: 0, y: 30 }}
//             whileInView={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.8 }}
...
//                 <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
//             <Link href="/demo">
//                     <button className="bg-white text-blue-600 px-10 py-4 rounded-2xl text-lg font-semibold hover:shadow-2xl transition-all duration-300 flex items-center gap-3">
//                       <Rocket className="w-5 h-5" />
//                       Schedule Your Demo
...
//                 <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
//                 <Link href="/demo">
//                     <button className="border-2 border-white/50 text-white px-10 py-4 rounded-2xl text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300">
//                       Talk to Sales
//                   </button>
//                 </Link>
//                 </motion.div>
...
//           transition={{ duration: 0.5 }}
//           className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-3xl p-12 text-center"
//         >
...
//               <div className="text-blue-300 text-sm">{testimonials[currentIndex].location}</div>
//             </div>
//           </div>
//         </motion.div>
//       </AnimatePresence>
  ...
  return (
    <>
      <div className="min-h-screen bg-[#020917] overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center mb-16 sm:mb-20">
              ...
              >
                <div className="bg-gradient-to-br from-blue-900/40 to-blue-800/20 backdrop-blur-xl border border-blue-700/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8">
                  ...
                  <blockquote className="text-xl sm:text-2xl text-white font-medium mb-4 sm:mb-6 leading-relaxed">
                    "Every feature we build comes from real problems we've solved in the field. That's what makes Bleaum
                    different."
                  </blockquote>
        ...
        {/* CTA Section */}
        <section data-section="13" className="py-20 sm:py-32 relative overflow-hidden rounded-3xl mx-4 sm:mx-6 lg:mx-8">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600 via-blue-500 to-cyan-600 rounded-3xl"></div>
          <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_25%,rgba(255,255,255,0.05)_50%,transparent_75%)] bg-[length:40px_40px] rounded-3xl"></div>
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center rounded-3xl">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6">Ready to Transform Your Business?</h2>
              <p className="text-lg sm:text-xl text-blue-100 mb-8 sm:mb-12 leading-relaxed max-w-2xl mx-auto">
                Join 300+ retailers who've already made the switch. See the difference in just 24 hours.
              </p>

              <motion.div
                className="flex flex-col gap-4 sm:flex-row sm:gap-6 justify-center items-center mb-12 sm:mb-16"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.2 }}
                viewport={{ once: true }}
              >
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <Link href="/demo">
                    <button className="bg-white text-blue-600 px-8 py-3 sm:px-10 sm:py-4 rounded-2xl text-base sm:text-lg font-semibold hover:shadow-2xl transition-all duration-300 flex items-center justify-center gap-3 w-full sm:w-auto">
                      <Rocket className="w-4 h-4 sm:w-5 sm:h-5" />
                      Schedule Your Demo
                ...
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="w-full sm:w-auto">
                  <Link href="/demo">
                    <button className="border-2 border-white/50 text-white px-8 py-3 sm:px-10 sm:py-4 rounded-2xl text-base sm:text-lg font-semibold hover:bg-white hover:text-blue-600 transition-all duration-300 w-full sm:w-auto">
                      Talk to Sales
                    </button>
                  </Link>
                </motion.div>
